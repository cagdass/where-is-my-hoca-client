    ...
    render() {
        return (<div>
            ...
            <Row>
                ...
                <br/>
                <p className="about_p">I meant to work on a web application to share all the professors' schedules and the classroom schedules for some time.</p>
                <br/>
                <p className="about_p">Learning <i>some</i> React made it much easier. Many thanks go to <a href="http://20satir.com">20satir</a> where I got to learn what I learned. And also to Facebook, who created React in the first place.</p>
                <br/>
                ...
                <p className="about_p">And no. Office hours are not likely to come unless arrangements are to be made so that I can fetch the entire data like I did for classes.</p>
